...
def _copy_tooling(
    ...
    paths = tuple(dict.fromkeys(schema.capture_tooling_paths + schema.auditor_tooling_paths))
    ...
    try:
        ...
        manifest = {
            ...
            "tooling": {
                ...
                "auditorSHA256": tooling_digest(retained_reference, schema.auditor_tooling_paths),
            },
            "runs": run_records,
            "boundaries": {
