    ...
    extension DebugEditorFindFixtureWorkspaceHandle {
        static func open(
            ...
            do {
                let identity = try DebugEditorFindFixtureWorkspaceHandleIO
                ...
                let ownershipMarkerIdentity = try DebugEditorFindFixtureWorkspaceHandleIO
        ...
        static func reopen(
            ...
            do {
                ...
                guard ownershipMarkerDescriptor >= 0,
                      try DebugEditorFindFixtureWorkspaceHandleIO
                      .regularFileIdentity(ownershipMarkerDescriptor)
    ...
    enum DebugEditorFindFixtureWorkspaceHandleIO {
