...
1. Finish native selection/caret evidence, including true mouse/click-to-caret behavior near folded delimiters (now the top blocker after actual Pinyin passed).
2. Keep the opt-in actual IME (Zhuyin + Pinyin) harness runnable as regression coverage; re-run it before any user-facing WYSIWYG mode.
