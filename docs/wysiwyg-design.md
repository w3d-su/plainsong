...
>
> Remaining prerequisite: **this design doc is not approved**. M5 is accepted, but Phase 2
> implementation is still blocked until the maintainer approves this design gate.
